...
static void apply(const plan *ego_, R *I, R *O)
{
     ...
     // if(myRank == 0) printf("first DFT starts\n");
     // fflush(stdout);
     firstFFT = true;
     /* 1d DFT(s) */
     ...
     firstFFT = false;
     // if(myRank == 0) printf("first DFT done\n");
     // fflush(stdout);
     //elapsedTime += MPI_Wtime();
     //printf("FFT_1 time: %f\n", elapsedTime);

     //elapsedTime = -MPI_Wtime();
     // if(myRank == 0) printf("second Transpose starts\n");
     // fflush(stdout);
     secondTranspose = true;
     /* global transpose */
     cldt_after = (plan_rdft *) ego->cldt_after;
     cldt_after->apply(ego->cldt_after, I, O);
     secondTranspose = false;
     //elapsedTime += MPI_Wtime();
     //printf("Transpose_2 time: %f\n", elapsedTime);
     // if(myRank == 0) printf("second Transpose done\n");
     // fflush(stdout);
}
