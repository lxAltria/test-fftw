...
libfftw3_la_DEPENDENCIES = kernel/libkernel.la \
...
am__v_lt_0 = --silent
am__v_lt_1 = 
libfftw3_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
	$(AM_CFLAGS) $(CFLAGS) $(libfftw3_la_LDFLAGS) \
	$(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(libfftw3_la_SOURCES)
DIST_SOURCES = $(libfftw3_la_SOURCES)
...
ACLOCAL = ${SHELL} /home/xin/codes/fft/ftfft/fftw_ip2/missing aclocal-1.14
ALLOCA = 
ALTIVEC_CFLAGS = 
AMTAR = $${TAR-tar}
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/xin/codes/fft/ftfft/fftw_ip2/missing autoconf
AUTOHEADER = ${SHELL} /home/xin/codes/fft/ftfft/fftw_ip2/missing autoheader
AUTOMAKE = ${SHELL} /home/xin/codes/fft/ftfft/fftw_ip2/missing automake-1.14
AVX2_CFLAGS = 
AVX512_CFLAGS = 
AVX_128_FMA_CFLAGS = 
AVX_CFLAGS = 
...
FLIBS =  -L/usr/lib/gcc/x86_64-redhat-linux/4.8.5 -L/usr/lib/gcc/x86_64-redhat-linux/4.8.5/../../../../lib64 -L/lib/../lib64 -L/usr/lib/../lib64 -L/blues/gpfs/home/software/spack-0.10.1/opt/spack/linux-centos7-x86_64/intel-17.0.4/intel-mkl-2017.3.196-v7uuj6zmthzln35n2hb7i5u5ybncv5ev/compilers_and_libraries_2017.4.196/linux/tbb/lib/intel64_lin/gcc4.7 -L/blues/gpfs/home/software/spack-0.10.1/opt/spack/linux-centos7-x86_64/intel-17.0.4/intel-mkl-2017.3.196-v7uuj6zmthzln35n2hb7i5u5ybncv5ev/compilers_and_libraries_2017.4.196/linux/compiler/lib/intel64_lin -L/blues/gpfs/home/software/spack-0.10.1/opt/spack/linux-centos7-x86_64/intel-17.0.4/intel-mkl-2017.3.196-v7uuj6zmthzln35n2hb7i5u5ybncv5ev/compilers_and_libraries_2017.4.196/linux/mkl/lib/intel64_lin -L/blues/gpfs/home/software/spack-0.10.1/opt/spack/linux-centos7-x86_64/intel-17.0.4/intel-mkl-2017.3.196-v7uuj6zmthzln35n2hb7i5u5ybncv5ev/lib -L/blues/gpfs/home/software/spack-0.10.1/opt/spack/linux-centos7-x86_64/gcc-4.8.5/intel-17.0.4-74uvhjiulyqgvsmywifbbuo46v5n42xc/tbb/lib/intel64/gcc4.4 -L/blues/gpfs/home/software/spack-0.10.1/opt/spack/linux-centos7-x86_64/gcc-4.8.5/intel-17.0.4-74uvhjiulyqgvsmywifbbuo46v5n42xc/lib/intel64 -L/usr/lib/gcc/x86_64-redhat-linux/4.8.5/../../.. -lgfortran -lm -lquadmath
GREP = /usr/bin/grep
INDENT = 
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/xin/codes/fft/ftfft/fftw_ip2/missing makeinfo
MANIFEST_TOOL = :
...
VERSION = 3.3.5
VSX_CFLAGS = 
abs_builddir = /home/xin/codes/fft/ftfft/fftw_ip2
abs_srcdir = /home/xin/codes/fft/ftfft/fftw_ip2
abs_top_builddir = /home/xin/codes/fft/ftfft/fftw_ip2
abs_top_srcdir = /home/xin/codes/fft/ftfft/fftw_ip2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
ac_ct_F77 = gfortran
...
install_sh = ${SHELL} /home/xin/codes/fft/ftfft/fftw_ip2/install-sh
...
pdfdir = ${docdir}
prefix = /home/xin/codes/fft/ftfft/utils/ftfftw_ip
...
lib_LTLIBRARIES = libfftw3.la
GENFFT = 

# pkgincludedir = $(includedir)/fftw3
...
##COMBINED_THREADLIBS = threads/libfftw3_threads.la
libfftw3_la_SOURCES = 
libfftw3_la_LIBADD = \
	kernel/libkernel.la				\
	dft/libdft.la					\
...
libfftw3_la_LDFLAGS = -no-undefined -version-info	\
8:5:5  $(ENVIRONMENT_LIBFFTW3_LDFLAGS)


# cannot use -no-undefined since dependent on libquadmath
#libfftw3_la_LDFLAGS = -version-info 8:5:5 $(ENVIRONMENT_LIBFFTW3_LDFLAGS)
pkgconfigdir = $(libdir)/pkgconfig
pkgconfig_DATA = fftw3.pc
WISDOM_DIR = /etc/fftw
WISDOM = wisdom
...
libfftw3.la: $(libfftw3_la_OBJECTS) $(libfftw3_la_DEPENDENCIES) $(EXTRA_libfftw3_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libfftw3_la_LINK) -rpath $(libdir) $(libfftw3_la_OBJECTS) $(libfftw3_la_LIBADD) $(LIBS)
...
wisdom:
	tools/fftw-wisdom -o $@ $(WISDOM_FLAGS)
